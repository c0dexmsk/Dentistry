        ...
        <section>
            <div className="team margin-top-100">
                ...
                <div className="row flex-nowrap mt-5">
                    <div className="col-3">
                        <img className="container-fluid" src={bitrixData.PHOTO1} alt="Маликов Малик Шарапудинович" />
                    ...
                    <div className="col-3">
                        <img className="container-fluid" src={bitrixData.PHOTO2} alt="Сулейманов Шамиль Гусейнович" />
                    ...
                    <div className="col-3">
                        <img className="container-fluid" src={bitrixData.PHOTO3} alt="Ибрагимов Гаджи Бахмудович" />
